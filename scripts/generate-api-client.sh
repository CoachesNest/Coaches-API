#!/usr/bin/env bash
# =============================================================================
# Coaches – API Client Generation Script
#
...
# Prerequisites:
#   - Node.js 18+
#   - Running Coaches backend OR OPENAPI_URL pointing to an existing spec
#
# Options:
#   --output <dir>         Output directory (default: ../frontend/src/api-client)
#   --package-name <name>  NPM package name    (default: @coaches/api-client)
...
PACKAGE_NAME="${PACKAGE_NAME:-@coaches/api-client}"
SPEC_URL="${OPENAPI_URL:-http://localhost:3000/api-docs-json}"
SPEC_FILE="/tmp/coaches-openapi.json"
