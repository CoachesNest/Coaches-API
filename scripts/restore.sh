#!/usr/bin/env bash
# =============================================================================
# Coaches PostgreSQL Restore Script
#
...
# Usage:
#   ./restore.sh <s3-key>
#   ./restore.sh backups/coaches/20260101T120000Z/coaches_20260101T120000Z.dump.enc
#
# Required environment variables:
#   DB_HOST, DB_PORT, DB_NAME, DB_USER, DB_PASSWORD
#   BACKUP_ENCRYPTION_KEY   – must match the key used during backup
#   AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY
#   S3_BUCKET               – e.g. s3://coaches-backups
#
...
RESTORE_DIR="/tmp/coaches-restore-$$"
