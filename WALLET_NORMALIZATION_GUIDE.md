...
A production-ready utility system for normalizing, validating, and comparing Stellar wallet addresses throughout the Coaches server. Ensures consistent storage, case-safe comparison, and robust error handling.
