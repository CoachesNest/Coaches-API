...
PGPASSWORD="password" psql -h localhost -p 5432 -U postgres -d coaches_db -c "\dt database_backups"
```
...
# Database size
PGPASSWORD="password" psql -h localhost -p 5432 -U postgres -d coaches_db -c \
  "SELECT pg_size_pretty(pg_database_size('coaches_db'));"
```
