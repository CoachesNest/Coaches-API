# Coaches Contract Error Codes Spec

This document defines the standard error codes used by the Coaches smart contracts. Each error code is a unique numeric value between 0 and 255.
