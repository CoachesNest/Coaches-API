...
NestJS backend API for Coaches - A mentorship matching platform built with enterprise architecture.

[![CI/CD Pipeline](https://github.com/MentoNest/Coaches_Server/actions/workflows/ci-cd.yml/badge.svg)](https://github.com/MentoNest/Coaches_Server/actions/workflows/ci-cd.yml)
...
```bash
git clone https://github.com/MentoNest/Coaches_Server.git
cd Coaches_Server
```
...
- 📧 Email: support@coaches.com
- 🐛 Issues: [GitHub Issues](https://github.com/MentoNest/Coaches_Server/issues)
- 💬 Discussions: [GitHub Discussions](https://github.com/MentoNest/Coaches_Server/discussions)
...
Built with ❤️ by the Coaches Team
