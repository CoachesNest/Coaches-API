...
// ============================================================================
// Coaches Escrow Contract Tests — issues #521 #522 #523 #525 #526 #527
// ============================================================================

mod test_coaches_escrow {
    use super::super::{EscrowError, FeeSplit, CoachesEscrow, CoachesEscrowClient, Status};
    use soroban_sdk::{
    ...
    fn setup() -> (Env, Address, Address, Address, Address, Address) {
        ...
        let token_id = env
            ...
            .address();
        StellarAssetClient::new(&env, &token_id).mint(&buyer, &1000);
        let cid = env.register(CoachesEscrow, ());
    ...
    fn test_lock_funds_stores_session_with_locked_status() {
        ...
        let client = CoachesEscrowClient::new(&env, &cid);
    ...
    #[test]
    fn test_coaches_platform_fee_and_treasury() {
        let (env, admin, _, _, _, cid) = setup();
        let client = CoachesEscrowClient::new(&env, &cid);
        client.initialize(&admin);
