...
impl CoachesContract {
    ...
    pub fn initialize(env: Env, admin: Address, treasury: Address) {
        ...
        env.events().publish(("Coaches",), Initialized { admin, treasury });
    }
    ...
    pub fn set_platform_fee(env: Env, new_fee_bps: u32) {
        ...
        env.events()
            .publish(("Coaches",), PlatformFeeUpdated { new_fee_bps });
    }
    ...
    pub fn set_treasury(env: Env, new_treasury: Address) {
        ...
        env.events()
            .publish(("Coaches",), TreasuryUpdated { new_treasury });
    }
    ...
    pub fn set_dispute_window(env: Env, window_ledgers: u32) {
        ...
        env.events()
            .publish(("Coaches",), DisputeWindowUpdated { window_ledgers });
    }
...
mod tests {
    ...
    fn setup() -> (Env, Address, Address, CoachesContractClient<'static>) {
        let env = Env::default();
        env.mock_all_auths();
        let contract_id = env.register(CoachesContract, ());
