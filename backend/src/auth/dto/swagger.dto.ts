...
export class NonceResponseDto {
  @ApiProperty({
    description: 'Nonce string for the user to sign',
    example: 'Sign this message to authenticate with Coaches: a1b2c3...',
  })
  nonce: string;

  @ApiProperty({
    description: 'Nonce expiration timestamp (Unix ms)',
...
export class RevokeAllResponseDto {
  ...
  @ApiProperty({
    description: 'Wallet address whose sessions were revoked',
    example: 'GABC...',
  })
