...
async function bootstrap() {
  ...
  if (enableSwagger) {
    const config = new DocumentBuilder()
      ...
      .setDescription(
        'Coaches Backend API Documentation. Complete endpoints for Authentication, Wallet Verification, Session Revocation, User Profiles, and Security Monitoring.',
      )
      .setVersion('1.0.0')
      .addBearerAuth(
        {
    ...
    SwaggerModule.setup('api/docs', app, document, {
      ...
      customSiteTitle: 'Coaches API Docs',
    });
  } else {
