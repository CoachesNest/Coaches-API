...
@Module({
  imports: [
    TypeOrmModule.forRoot({
      ...
      database: process.env.DB_DATABASE || 'coaches',
      entities: [User, Role, RefreshToken, AuditLog, MentorProfile, MenteeProfile],
      synchronize: process.env.NODE_ENV !== 'production',
    }),
    TypeOrmModule.forFeature([User, Role, RefreshToken, AuditLog, MentorProfile, MenteeProfile]),
    JwtModule.register({
